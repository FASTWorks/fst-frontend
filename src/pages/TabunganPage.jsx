...
// [UBAH BAGIAN INI MENJADI STATE]
  const [tabunganData, setTabunganData] = useState([
    { 
      ...
      days: '5.915 Days', 
      progress: 65, 
      saved: 'Rp8.450.000.000', 
      target: 'Rp13.000.000.000' 
    },
    { 
      id: 2, 
      title: 'iPhone 17 Pro Max 2 TB', 
      days: '113 Days', 
      progress: 65, 
      saved: 'Rp16.184.350', 
      target: 'Rp24.899.000' 
          ...
          <div className="max-w-6xl mx-auto flex flex-col gap-8">
            ...
            <div className="bg-linear-to-r from-[#8C3A7A] to-[#A2448F] rounded-3xl p-6 md:p-10 flex flex-col md:flex-row justify-between md:items-center shadow-md text-white gap-6">
              <div>
                ...
                <div className="inline-flex items-center gap-1.5 bg-white/20 rounded-full px-3 py-1 text-xs font-semibold backdrop-blur-sm">
                  <TrendingUpIcon />
                  +12.5% this month
                </div>
              </div>
